...
public class AutoConstants {
	...
	public static class SwitchMiddle {
		...
		public static final long
			INITIAL_PAUSE = 500,
			SIDEWAYS_FORWARD_FULL_SPEED_DRIVE_TIME_LEFT = 1275,//4261,
			SIDEWAYS_FORWARD_FULL_SPEED_DRIVE_TIME_RIGHT = 1375, //3917, //978
			FORWARD_ACCELERATION_TIME = 980,
			FORWARD_DECELERATION_TIME = 980,
			BACKWARDS_FULL_SPEED_DRIVE_TIME = 1850, //1729, //1024
			BACKWARDS_ACCELERATION_TIME = 896,
			BACKWARDS_DECELERATION_TIME = 546,
			INTAKE_DECELERATION_TIME = 300,
			INTAKE_FULL_SPEED_DRIVE_TIME = 800,//1000,
